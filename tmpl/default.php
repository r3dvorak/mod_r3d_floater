...
?>
<div id="r3d-floater-<?= $mid; ?>" class="r3d-floater r3d-floater--hidden" data-mid="<?= $mid; ?>"
    data-direction="<?= $dir; ?>" data-width="<?= $w; ?>" data-height="<?= $h; ?>" data-auto-open="<?= $auto; ?>"
    data-show-close="<?= $close; ?>" data-frequency="<?= $freq; ?>" data-key-prefix="<?= $pref; ?>" aria-hidden="true"
    role="dialog">
    <div class="r3d-floater__panel" style="width:<?= $w; ?>px;height:<?= $h; ?>px;" role="document">
